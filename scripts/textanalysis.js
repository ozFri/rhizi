...
function TextAnalyser(newtext){
  ...
  console.log(order);
      ...
      switch(order){
        case states[0]:
        window.setTimeout(function(){$('#textanalyser').css('box-shadow','0 0 0px #303030')},200);
        break;
        case states[1]:
        ...
        if(nodereplaced===true){
              ...
              if(AddedUnique(newnode)){
                ...
                graph.addLink(addednodes[nodecounter-2],newnode,newlink);
              ...
              graph.addLink(addednodes[nodecounter-1],"",newlink);
              break;
              case states[5]:
